...
To zadanie było przykładem wykorzystania prawdziwej poddatności z roku 2021, znanej jako CVE-2021-44228, a potocznie nazywanej „Log4Shell”.
...
Abu uzyskać dostęp do serwera należało wykorzystać podatność Log4Shell, wysyłając odpowiednio spreparowane żądanie HTTP do usługi Solr.
...
Solar wysyła żądanie do naszego serwera LDAP, który zwraca referencję do klasy JAVA, którą następnie pobiera z naszego serwera HTTP i wykonuje na serwerze ofiary.
